...
const observerOptions = {
    root: null,
    // Adjusted rootMargin to be more aggressive in mobile view but standard on desktop
...
// --- LANGUAGE TRANSLATION FUNCTION (Includes RTL Handling) ---
...
function setLanguage(lang) {
    ...
    // 3. Update the HTML lang attribute AND direction for RTL support
    document.documentElement.setAttribute('lang', lang);
    const isRTL = lang === 'ar'; 
    document.documentElement.setAttribute('dir', isRTL ? 'rtl' : 'ltr');
    document.body.style.textAlign = isRTL ? 'right' : 'left'; // Basic global text alignment change

    // Optional: Update the language icon text to show the active language
    if (langIcon) {
...
function loadTheme() {
    ...
    // Check for saved theme, otherwise default to system preference
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initial active link setting for the Home section on load
